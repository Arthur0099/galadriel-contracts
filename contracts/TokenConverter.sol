...
contract TokenConverter is WhitelistedRole {
     ...
     */
    function convertToPGC(address tokenAddr, uint256 tokenAmount) public view returns (uint256) {
     ...
     */
    function convertToToken(address tokenAddr, uint256 pgcAmount) public view returns (uint256) {
        Token memory token = tokens[tokenAddr];
